...
channel13 = Channel.create(name: 'running-out-of-channel-name-ideas3', channel_type: 'group')
channel14 = Channel.create(name: 'running-out-of-channel-name-ideas4', channel_type: 'group')
channel15 = Channel.create(name: 'direct1', channel_type: 'direct')
channel16 = Channel.create(name: 'direct2', channel_type: 'direct')
channel17 = Channel.create(name: 'direct3', channel_type: 'direct')
channel18 = Channel.create(name: 'direct4', channel_type: 'direct')
channel19 = Channel.create(name: 'direct5', channel_type: 'direct')
channel20 = Channel.create(name: 'direct6', channel_type: 'direct')
channel21 = Channel.create(name: 'direct7', channel_type: 'direct')